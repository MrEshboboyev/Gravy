...
namespace Gravy.Persistence.Migrations
{
    ...
    [Migration("20241213140101_AddDeliveryRadiusInVehicleToDeliveryPersonTable")]
    partial class AddDeliveryRadiusInVehicleToDeliveryPersonTable
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("Gravy.Domain.ValueObjects.Vehicle", "Vehicle", b1 =>
                        {
                            ...
                            b1.Property<double>("MaxDeliveryRadius")
                                .HasColumnType("double precision")
